...
certified residual to $10^{-8}$ and attains the same $L^{-1/2}$ rate
uniformly up to $d = 5$, locating the nonlinear open problem in the
approximation constant, not the certificate or the rate.
\end{abstract}
