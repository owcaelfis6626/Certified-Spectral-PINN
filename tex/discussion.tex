...
seeds per $(d, L)$ (39 cells, 22.3 GPU-hours):
...
\midrule
2 & 14  & 0.298 & 0.208 & 0.160 & 0.117 & $-0.445 \pm 0.018$ \\
3 & 61  & 0.324 & 0.228 & 0.159 & 0.118 & $-0.492 \pm 0.013$ \\
4 & 212 & 0.385 & 0.270 & 0.186 & 0.133 & $-0.514 \pm 0.006$ \\
5 & 671 & 0.476 & 0.333 & 0.233 & ---   & $-0.517 \pm 0.001$ \\
\bottomrule
\end{tabular}
\end{center}

\noindent (the $d = 5$ slope is fitted on three $L$ points; the others on
four). Three points deserve emphasis. First, the certified residual is
...
$L^{-1/2}$ rate is attained, and is so here to within $11\%$ --- gives
...
KL rate (rel\_err slopes $-0.445, -0.492, -0.514, -0.517$;
